...
1. Update UI: `services/simulated-factory/templates/fragments/twin.html`
...
2. Update API parsing: `services/simulated-factory/simulated_factory/api.py`
...
3. Tests: `services/simulated-factory/tests/`
