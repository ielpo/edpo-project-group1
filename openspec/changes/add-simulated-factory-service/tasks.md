...
- [x] Scaffold simulator repository
...
- [x] Add simulator config to `dobot-control`
...
- [x] Implement `simulator_client.py` and DobotFake integration
...
- [x] Implement hardware adapters with forwarding semantics
...
- [x] Implement Simulation Engine core
...
- [x] REST API, WebSocket, and in-memory event history
...
- [x] Docker Compose development snippet
...
- [x] Health endpoint and API contract versioning
...
- [x] Event-bridge configuration docs
