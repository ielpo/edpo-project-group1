...
@Component("publishManufacturingCompleteDelegate")
public class PublishManufacturingCompleteDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
        try {
            ...
            eventPublishingUseCase.publishOrderComplete(order.orderId(), correlationId);
        } catch (Exception e) {
            log.error("Could not publish manufacturing complete message: {}", e.getMessage());
